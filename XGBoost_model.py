...
class XGBoostModelTraining:
    ...
    def hyperparameter_tuning(self, X, y):
        ...
        print("  Grid search results saved to 'xgboost_grid_search_results.csv'")
    ...
    def save_results(self, cv_results, test_results):
        ...
        cv_filename = f'xgboost_cv_results_{timestamp}.json'
        with open(cv_filename, 'w') as f:
            json.dump(cv_results, f, indent=2)
        print(f"  CV results saved to: {cv_filename}")

        test_filename = f'xgboost_test_results_{timestamp}.json'
